...
CMD mkdir /home/elasticsearch/data
CMD sh elasticsearch/bin/elasticsearch -E path.data=/home/elasticsearch/data -E http.host=0.0.0.0 & kibana/bin/kibana --host 0.0.0.0
